...
export default class TareaRepository extends TareasDataSource {
    ...
    obtenerTodas() {
        try {
            ...
            // Si ocurre un error, como que el archivo no exista, devolvemos un array vacío console.error('Error al leer el archivo de tareas:', error);
            return [];
        }
    }
...
guardar(tareas){
    ...
    // Guardar la cadena JSON en el archivo de texto fs.writeFileSync (filePath, data, 'utf-8');
    } catch (error) {
